"""Descriptive statistics of Section 4, and the regime block of Section 6.

Thin CLI. Every statistic lives in ``milan_traffic.edastats``; this file only sequences
them, renders the markdown and writes the file. Section 8 promises that every number
...
def main(argv: list[str] | None = None) -> int:
    ...
    lines = [
        ...
        "land-use claim in Section 4, and the caption of the grid heatmap, depends on it.",
        "",
        ...
        "Section 4 is checked against; the land uses themselves are a hypothesis those addresses "
        ...
        "magnitude are why the cross-area comparison in Section 6 leans on scale-free errors "
        "rather than on MAE.",
        "",
        ...
        "not how busy it was. This is the section Section 6's best-model argument rests on, so "
        ...
        "Section 6.4 rests on, and it is the one that actually separates the cells: the ratio "
        ...
        "convolutional model wins the architecture comparison that the reordering of Section 6.1 "
        "rests on.",
        "",
        ...
        "quantity as the persistence floor of Section 6 seen from the decomposition side. The "
